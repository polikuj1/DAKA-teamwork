    ...
    <section class="news">
      ...
      <div class="news_tab_content">
        ...
        <div v-show="currentTab === 'all'">
          <div
            v-for="message in paginatedAllMessages"
            :key="message.id"
            class="message"
          >
            <div class="news_pic">
        ...
        <div v-show="currentTab === 'latest'">
          <div
            v-for="message in paginatedlatestMessages"
            :key="message.id"
            class="message"
          >
            <div class="news_pic">
        ...
        <div v-show="currentTab === 'activity'">
          <div
            v-for="message in paginatedActivityMessages"
            :key="message.id"
            class="message"
          >
            <div class="news_pic">
...
export default {
    ...
    return {
      ...
      allMessages: [
        ...
        },
        {
          ...
          date: "2023-11-01",
          content:
            "🎁萬眾期待的抽獎活動開始了！抓住這個難得的機會，贏得豐富的獎品！"
        },
        {
          category: "NEWS",
  ...
  methods: {
    changeTab(tabName) {
      ...
      //分類消息類別
      if (tabName === "latest") {
        this.latestMessages = this.allMessages.filter(
          (message) => message.category === "NEWS"
        );
      } else if (tabName === "activity") {
        this.activityMessages = this.allMessages.filter(
